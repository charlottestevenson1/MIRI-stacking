...
for i in range(len(bands)):
    ...
    fits.writeto(f'Stacking/Masked inverse variance stacking/Stacked images/SCI/{band}_stack.fits', stack, overwrite = True)
    fits.writeto(f'Stacking/Masked inverse variance stacking/Stacked images/ERR/{band}_stack_ERR.fits', stack_err, overwrite=True)
