...
output_dir = "development/black_spot_diagnosis/substack/Histograms"
...
for band in bands:
    ...
    filename = f"development/black_spot_diagnosis/substack/stacks/{band}_stack_MEDIAN_200.fits"
