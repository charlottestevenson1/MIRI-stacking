...
go_galaxy_IDs = [int(i) for i in open('development/stacking/Objects for stacking.txt').readlines()][:50]
...
for band in bands:
    ...
    fits.writeto(f'development/black_spot_diagnosis/substack/stacks/{band}_stack_MEDIAN_200.fits', stack, overwrite = True)
