...
hdul = fits.open('fits_files/goods-s catalog.fits')
...
with open('development/prospector/stack_data/8-9 Fluxes.txt') as f:
    mea_fluxes = [float(i) for i in f.readlines()]
    mea_fluxes = [mea_fluxes[i] for i in [0,1,2,3,6,9,12,15,18,19,20,21,22,23,24,25]]

with open('development/prospector/stack_data/8-9 Errors.txt') as f:
