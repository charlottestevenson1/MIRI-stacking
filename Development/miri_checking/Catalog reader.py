...
hdul = fits.open('/data/cs2399/fits_files/goods-s catalog.fits')
...
with open(f'development/miri_checking/{ID} catalog fluxes.txt', 'w') as f:
...
with open(f'development/miri_checking/{ID} catalog errors.txt', 'w') as f:
