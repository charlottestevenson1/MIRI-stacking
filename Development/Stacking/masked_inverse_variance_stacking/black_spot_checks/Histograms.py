...
output_dir = "development/stacking/masked_inverse_variance_stacking/black_spot_checks/Histograms"
os.makedirs(output_dir, exist_ok=True)

for band in bands:
    filename = f"development/stacking/masked_inverse_variance_stacking/Stacked images/SCI/{band}_stack.fits"
