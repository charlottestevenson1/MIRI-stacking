...
for band in bands:
    ...
    #plt.show()
    plt.savefig(f"development/stacking/masked_inverse_variance_stacking/black_spot_checks/Random aperture placement plots/{band}_RAPT.png", bbox_inches="tight")
    plt.close()