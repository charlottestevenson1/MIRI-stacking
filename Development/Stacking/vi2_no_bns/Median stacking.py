...
stacking_galaxy_IDs = [int(i) for i in open('development/stacking/vi2_no_bns/to keep.txt').readlines()]
...
for band in bands:
    ...
    fits.writeto(f'development/stacking/vi2_no_bns/median_stacking/{band}_stack_MEDIAN.fits', stack, overwrite = True)
