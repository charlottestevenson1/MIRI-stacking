...
for band in bands:
    ...
    #plt.show()
    plt.savefig(f"Development/Stacking/Masked inverse variance stacking/Black spot checks/Random aperture placement plots/{band}_RAPT.png", bbox_inches="tight")
    plt.close()