...
output_dir = "Development/Stacking/Masked inverse variance stacking/Black spot checks/Histograms"
os.makedirs(output_dir, exist_ok=True)

for band in bands:
    filename = f"Development/Stacking/Masked inverse variance stacking/Stacked images/SCI/{band}_stack.fits"
