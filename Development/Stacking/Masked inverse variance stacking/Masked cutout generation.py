...
for i in range(26):
    ...
    for ID in IDs:
        ...
        seg = fits.getdata(f'Development/Cutouts/SCI/{ID}_segmentation.fits')
        # plt.imshow(image)
        # plt.show()
        ...
        fits.writeto(
            f"Development/Stacking/Masked inverse variance stacking/Masked cutouts/SCI/{ID}_{band}_MASKED.fits",
            masked_image,
            overwrite = True
        )
