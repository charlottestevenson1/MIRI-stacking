...
stacking_galaxy_IDs = [int(i) for i in open('Development/Stacking/VI2 no BNs/to keep.txt').readlines()]
...
for band in bands:
    ...
    fits.writeto(f'Development/Stacking/VI2 no BNs/Median stacking/{band}_stack_MEDIAN.fits', stack, overwrite = True)
