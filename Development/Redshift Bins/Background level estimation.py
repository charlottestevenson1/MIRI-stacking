...
for z_range in z_ranges:
    ...
    with open(f'Development/Redshift Bins/Stacks/Redshifts {zlo}-{zup}/Background levels.txt', 'w') as f:
        f.writelines(str(flux_medians[i])+'\n' for i in range(len(bands)))
    with open(f'Development/Redshift Bins/Stacks/Redshifts {zlo}-{zup}/Background levels MAD.txt', 'w') as f:
