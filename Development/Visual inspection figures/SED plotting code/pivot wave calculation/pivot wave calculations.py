...
for band in filterlist:
    filepath = 'Development/Visual inspection figures/SED plotting code/pivot wave calculation/profile data/' + band + '.dat'
...
#save this in file
with open('Development/Visual inspection figures/SED plotting code/pivot wave calculation/pivot_waves.txt', 'w') as f:
