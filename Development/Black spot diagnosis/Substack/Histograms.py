...
bands = [
    ...
    "F210M", "F250M", "F277W", "F300M", "F335M", "F356W", "F410M", "F444W", "F480M", "F560W", "F770W", "F1000W",
...
output_dir = "Development/Black spot diagnosis/Substack/Histograms"
...
for band in bands:
    ...
    filename = f"Development/Black spot diagnosis/Substack/Stacks/{band}_stack_MEDIAN_200.fits"
    ...
    fig.suptitle(band, fontsize=15)
    fig.supxlabel("Pixel value")
    fig.supylabel("Probability density")
    axes[0].set_xlim(None, xlim)
