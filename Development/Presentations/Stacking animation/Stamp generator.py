...
for band in bands:
    mosaic = fits.open(f'Development/Redshift Bins/Stacks/Redshifts 8-9/SCI/{band}_stack.fits')[0].data
    print(mosaic)
    ...
    plt.savefig(f'Development/Presentations/Stack stamps/{band}.png', transparent=True)
    plt.close()