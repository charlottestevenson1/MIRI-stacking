...
for i in range(1,15,1):
    ...
    for band in bands:
        ...
        band_galaxy_IDs = [
            int(i)
            for i in open(
                f"Development/Filter objects/{band} objects.txt"
            )
        ]
        ...
        SCI_array = np.stack([
            fits.getdata(
                f"Development/Stacking/Masked inverse variance stacking/"
        ...
        fits.writeto(
            f"Development/Presentations/Stacking animation/"
...
output_file = (
    "Development/Presentations/Stacking animation/"
