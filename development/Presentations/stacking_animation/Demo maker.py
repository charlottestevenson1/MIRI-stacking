...
stacking_galaxy_IDs = [
    int(i)
    for i in open(
        "development/stacking/Objects for stacking.txt"
    ).readlines()
]
...
for i in range(1,15,1):
    ...
    for band in bands:
        ...
        band_galaxy_IDs = [
            int(i)
            for i in open(
                f"development/filter_objects/{band} objects.txt"
            )
        ]
        ...
        SCI_array = np.stack([
            fits.getdata(
                f"development/stacking/masked_inverse_variance_stacking/"
        ...
        fits.writeto(
            f"development/presentations/stacking_animation/"
...
output_file = (
    "development/presentations/stacking_animation/"
