...
for band in bands:
    filepath = f'development/photometry/band_data/profile_data/{band}.dat'
...
with open('development/photometry/band_data/pivot_waves.txt', 'w') as f:
    for line in pwaves:
        f.writelines(str(line/1e4)+'\n') # conversion to microns

with open('development/photometry/band_data/Eff widths.txt', 'w') as f:
    for line in widths:
        f.writelines(str(line/1e4)+'\n')